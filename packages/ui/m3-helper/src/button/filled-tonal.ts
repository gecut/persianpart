...
export class GecutFilledTonalButtonDirective extends GecutDirective {
  constructor(partInfo: PartInfo) {
    super(partInfo, '<gecut-filled-tonal-button>');
  }

  render(content: ButtonContent): RenderResult {
    this.log.method?.('render');

    return html`<md-filled-tonal-button
...
export const filledTonalButton = directive(GecutFilledTonalButtonDirective);
